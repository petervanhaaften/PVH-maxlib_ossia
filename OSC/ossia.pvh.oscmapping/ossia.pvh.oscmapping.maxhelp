...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 51.5, 43.0, 33.0 ],
					"text" : "model name"
				}
...
, 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "ossia.pvh.oscreceive.module.maxpat",
					"numinlets" : 1,
					"numoutlets" : 2,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "signal" ],
...
,
		"dependency_cache" : [ 			{
				"name" : "ossia.pvh.oscreceive.module.maxpat",
				"bootpath" : "~/src/Max/PVH-maxlib_ossia/osc/ossia.pvh.oscreceive",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "ossia.pvh.oscreceive.model.maxpat",
				"bootpath" : "~/src/Max/PVH-maxlib_ossia/osc/ossia.pvh.oscreceive",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
