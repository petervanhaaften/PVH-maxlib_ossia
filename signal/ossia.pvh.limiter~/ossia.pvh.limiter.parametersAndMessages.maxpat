...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1116.5, 37.0, 114.0, 102.0 ],
					"text" : "ossia.parameter release @type decimal @range 0 1000 @clip low @unit time.ms @description \"The release time (ms).\"",
					"varname" : "release"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 614.0, 37.0, 130.0, 116.0 ],
					"text" : "ossia.parameter postamp @type decimal @range -6 48 @clip free @unit gain.dB @description \"The gain in dB applied to the signal after limiting. \"",
					"varname" : "postamp"
				}
