...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"lockeddragscroll" : 0,
					"maxclass" : "bpatcher",
					"name" : "ossia.pvh.saturation~.view.maxpat",
					"numinlets" : 1,
					"numoutlets" : 1,
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 37.0, 202.0, 175.0, 22.0 ],
					"text" : "ossia.pvh.saturation~.model #1"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1::obj-10" : [ "live.dial[1]", "Preamp", 0 ],
			"obj-1::obj-2" : [ "Depth", "Depth", 0 ],
