...
, 			{
		...
		"parameters" : 		{
			"obj-1::obj-4" : [ "Pitch shift (semintones)", "Pitch shift (semintones)", 0 ],
			"obj-1::obj-23" : [ "Feedback delay time", "Feedback delay time", 0 ],
			"obj-1::obj-15" : [ "Frequency offset", "Frequency offset", 0 ],
			"obj-1::obj-12" : [ "Invert", "Invert", 0 ],
			"obj-1::obj-17" : [ "Feedback level", "Feedback level", 0 ],
			"obj-1::obj-6::obj-10" : [ "live.text", "live.text", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "brita~.model.maxpat",
				"bootpath" : "~/dev/Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/hipno/brita",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
