...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 223.0, 309.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 134.5, 309.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 46.0, 309.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 223.0, 244.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 46.0, 244.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 46.0, 277.0, 196.0, 20.0 ],
					"text" : "vst~.model #1"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-1::obj-20" : [ "live.text", "live.text", 0 ],
			"obj-1::obj-37" : [ "live.text[3]", "live.text", 0 ],
			"obj-1::obj-36" : [ "live.text[2]", "live.text", 0 ],
			"obj-1::obj-24" : [ "live.text[1]", "live.text", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "vst~.view.maxpat",
				"bootpath" : "/Users/lossius/dev/Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/stereo/Plugins/vst~",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				"name" : "struplow.js",
				"bootpath" : "/Applications/Max 6.1/examples/javascript/lists+strings",
				"patcherrelativepath" : "../../../../../../../../../../../../../../Applications/Max 6.1/examples/javascript/lists+strings",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
