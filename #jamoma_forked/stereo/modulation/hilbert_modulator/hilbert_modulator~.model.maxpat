...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 276.0, 73.0, 45.0, 22.0 ],
					"style" : "",
					"text" : "j.in~ R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 276.0, 425.0, 52.0, 22.0 ],
					"style" : "",
					"text" : "j.out~ R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 41.0, 425.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "j.out~ L"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 41.0, 73.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "j.in~ L"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 546.0, 314.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "$1 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 546.0, 339.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 470.0, 381.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 405.333313, 76.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "$1 10"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 405.333313, 101.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "line~"
				}
...
,
					"patching_rect" : [ 276.0, 244.0, 213.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 276.0, 219.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "hilbert~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 233.0, 381.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "*~ 0"
				}
...
,
					"patching_rect" : [ 405.333313, 131.0, 83.666687, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 41.0, 244.0, 211.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 41.0, 219.0, 83.0, 22.0 ],
					"style" : "",
					"text" : "hilbert~"
				}
