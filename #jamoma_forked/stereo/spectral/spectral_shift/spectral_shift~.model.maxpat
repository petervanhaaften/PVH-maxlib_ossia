...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 899.0, 127.5, 273.0, 51.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 779.0, 143.0, 93.0, 20.0 ],
					"text" : "delay~ 768 768"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 680.0, 143.0, 93.0, 20.0 ],
					"text" : "delay~ 768 768"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 327.0, 216.0, 41.0, 20.0 ],
									"text" : "dbtoa"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 327.0, 272.0, 36.0, 20.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "signal", "bang" ],
									"patching_rect" : [ 503.0, 272.0, 36.0, 20.0 ],
									"text" : "line~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 327.0, 247.0, 39.0, 18.0 ],
									"text" : "$1 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 503.0, 247.0, 39.0, 18.0 ],
									"text" : "$1 10"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 125.0, 322.0, 32.5, 20.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 125.0, 387.0, 51.0, 20.0 ],
									"text" : "tapout~"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 125.0, 347.0, 67.0, 20.0 ],
									"text" : "tapin~ 200"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 322.0, 32.5, 20.0 ],
									"text" : "*~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 387.0, 51.0, 20.0 ],
									"text" : "tapout~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "tapconnect" ],
									"patching_rect" : [ 50.0, 347.0, 67.0, 20.0 ],
									"text" : "tapin~ 200"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 125.0, 467.0, 25.0, 25.0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 512.5, 378.0, 134.5, 378.0 ],
									"source" : [ "obj-20", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 512.5, 383.0, 59.5, 383.0 ],
									"source" : [ "obj-20", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 336.5, 297.0, 148.0, 297.0 ],
									"source" : [ "obj-21", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"disabled" : 0,
									"hidden" : 0,
									"midpoints" : [ 336.5, 303.0, 73.0, 303.0 ],
									"source" : [ "obj-21", 0 ]
								}
...
,
					"patching_rect" : [ 260.0, 269.0, 69.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 779.0, 383.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 17.0, 122.5, 80.0, 20.0 ],
					"text" : "prepend shift"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal", "signal", "" ],
					"patching_rect" : [ 210.0, 222.0, 391.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 680.0, 180.0, 43.0, 20.0 ],
					"text" : "j.in~ L"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 210.0, 339.0, 50.0, 20.0 ],
					"text" : "j.out~ L"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.0, 380.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 582.0, 16.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 380.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 396.0, 339.0, 52.0, 20.0 ],
					"text" : "j.out~ R"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 779.0, 180.0, 45.0, 20.0 ],
					"text" : "j.in~ R"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 319.5, 307.0, 615.25, 307.0, 615.25, 164.0, 591.5, 164.0 ],
					"source" : [ "obj-34", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 269.5, 315.0, 624.25, 315.0, 624.25, 157.0, 405.5, 157.0 ],
					"source" : [ "obj-34", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"patcherrelativepath" : "../../../../../../../../../../../../ntations/Max/Jamoma/patchers/modules/audio/stereo/Spectral/spectral_shift~",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
