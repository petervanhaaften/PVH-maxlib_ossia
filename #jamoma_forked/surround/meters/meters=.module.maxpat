...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 194.0, 216.0, 25.0, 25.0 ]
				}

			}
, 			{
				"box" : 				{
					"annotation" : "Meter bridge for mutlichannel signals",
					"fontname" : "Arial",
					"fontsize" : 12.0,
					"id" : "obj-2",
					"maxclass" : "newobj",
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 87.0, 261.0, 107.0, 20.0 ],
					"text" : "meters=.model #1"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "meters=.view.maxpat",
				"bootpath" : "/Users/jln/@Jamoma/Jamoma/Implementations/Max/Jamoma/patchers/modules/audio/surround/meters=",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
