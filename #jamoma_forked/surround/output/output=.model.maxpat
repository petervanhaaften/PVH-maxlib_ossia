...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 143.0, 56.0, 22.0 ],
					"style" : "",
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 148.0, 112.0, 50.0, 22.0 ],
					"style" : "",
					"text" : "del 500"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 148.0, 79.0, 36.0, 22.0 ],
					"style" : "",
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 39.5, 395.0, 5.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 26.5, 395.0, 5.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 40.5, 98.0, 5.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "list" ],
					"patching_rect" : [ 27.5, 98.0, 5.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 20.5, 63.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "j.unpack= 2"
				}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 50.0, 131.0, 24.0, 22.0 ],
													"style" : "",
													"text" : "t b"
												}
...
,
									"patching_rect" : [ 144.0, 186.0, 247.0, 22.0 ],
...
,
									"style" : "",
									"text" : "p queryAndSetNumberOfChannelsToRecord"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 38.5, 10.0, 254.0, 47.0 ],
									"style" : "",
									"text" : "This embeds all recording-related parameters and messages in a record/ subspace of the namespace."
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 101.0, 390.0, 25.0, 25.0 ],
									"style" : ""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 101.0, 68.0, 185.0, 22.0 ],
									"style" : "",
...
,
					"patching_rect" : [ 62.790344, 738.0, 55.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "open" ],
									"patching_rect" : [ 214.0, 197.0, 44.0, 22.0 ],
									"style" : "",
									"text" : "t open"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 391.0, 193.0, 97.0, 22.0 ],
									"style" : "",
									"text" : "j.stats 50 50"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 391.0, 118.0, 61.0, 22.0 ],
									"style" : "",
									"text" : "dspstate~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 391.0, 143.0, 69.0, 22.0 ],
									"style" : "",
									"text" : "qmetro 250"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 391.0, 168.0, 77.0, 22.0 ],
									"style" : "",
									"text" : "adstatus cpu"
								}
...
,
					"patching_rect" : [ 473.25, 742.0, 89.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 63.0, 278.5, 134.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 800.0, 344.0, 25.0, 25.0 ],
					"style" : ""
				}
...
,
					"patching_rect" : [ 471.5, 395.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.5, 363.0, 56.0, 22.0 ],
					"style" : "",
					"text" : "qlim 100"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 63.0, 429.0, 358.096771, 22.0 ],
					"style" : "",
					"text" : "j.unpack= 32",
					"varname" : "unpack"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 33,
					"outlettype" : [ "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "" ],
					"patching_rect" : [ 471.5, 429.0, 272.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "" ],
					"patching_rect" : [ 62.790344, 850.0, 46.0, 22.0 ],
					"style" : "",
					"text" : "j.out~ l"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 123.290344, 842.5, 302.0, 37.0 ],
					"style" : "",
					"text" : "Need to do this to set up the audio/gain parameter (as we don't yet have support for j.out=)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "audio.connect", "" ],
					"patching_rect" : [ 63.0, 349.0, 152.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 253.833344, 311.0, 81.0, 22.0 ],
					"style" : "",
					"text" : "prepend gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 66.0, 689.0, 344.5, 22.0 ],
					"style" : "",
					"text" : "sfrecord~ 32 645120",
					"varname" : "record"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 32,
					"numoutlets" : 0,
					"patching_rect" : [ 473.25, 689.0, 261.0, 35.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "float", "int", "int" ],
					"patching_rect" : [ 148.0, 49.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "audio.connect", "", "", "", "" ],
					"patching_rect" : [ 63.0, 163.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "j.info="
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 482.75, 772.0, 441.25, 772.0, 441.25, 685.0, 482.75, 685.0 ],
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 72.290344, 763.0, 47.290344, 763.0, 47.290344, 685.0, 75.5, 685.0 ],
					"source" : [ "obj-8", 0 ]
				}
