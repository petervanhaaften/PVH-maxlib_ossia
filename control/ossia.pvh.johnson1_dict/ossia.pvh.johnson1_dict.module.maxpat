...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 5.0, 312.0, 189.0, 22.0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "ossia.pvh.johnson1_dict.view.maxpat",
				"bootpath" : "~/src/PVH-maxlib_ossia/control/ossia.pvh.johnson1_dict",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "ossia.pvh.johnson1_dict.model.maxpat",
				"bootpath" : "~/src/PVH-maxlib_ossia/control/ossia.pvh.johnson1_dict",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
