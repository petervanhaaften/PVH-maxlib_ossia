...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 180.0, 137.5, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 180.0, 525.0, 300.0, 99.69999897480011 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 264.0, 152.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal", "float" ],
					"patching_rect" : [ 15.0, 484.30000102519989, 153.0, 70.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal", "float" ],
					"patching_rect" : [ 15.0, 411.30000102519989, 153.0, 71.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal", "float" ],
					"patching_rect" : [ 15.0, 340.0, 150.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 180.0, 645.0, 70.0, 22.0 ],
					"text" : "mc.pack~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 180.0, 675.0, 303.0, 69.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 180.0, 372.30000102519989, 168.0, 78.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 180.0, 456.80000102519989, 81.0, 62.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 180.0, 159.5, 150.0, 203.0 ],
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 189.5, 631.0, 240.5, 631.0 ],
					"order" : 0,
					"source" : [ "obj-23", 0 ]
				}
