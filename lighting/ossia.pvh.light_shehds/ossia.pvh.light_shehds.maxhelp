...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 451.0, 72.0, 22.0 ],
					"text" : "r test-rgbval"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 102.0, 379.0, 50.0, 49.0 ],
					"text" : "0 0 0 43 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 9.0, 3.0, 150.0, 210.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 9.0, 270.0, 271.0, 33.0 ],
					"text" : "RGBWD\n5 channel"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "ossia.pvh.light_shehds.module.maxpat",
				"bootpath" : "~/src/Max/PVH-maxlib_ossia/lighting/ossia.pvh.light_shehds",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
