...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 62.968361000000186, 150.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 111.718361000000186, 9.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.968361000000186, 9.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 62.968361000000186, 43.747771999999941, 119.0, 93.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-7::obj-1::obj-2" : [ "live.numbox[78]", "live.numbox", 0 ],
			"obj-7::obj-1::obj-6" : [ "live.numbox[77]", "live.numbox[1]", 0 ],
			"parameterbanks" : 			{
